    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-white " href="{{ route('admin.report.index') }}">
                <span class="sidenav-mini-icon"><i class="material-icons">bar_chart</i> </span>
        ...
        <li class="nav-item">
            <a class="nav-link text-white " href="{{ route('admin.agent.withdraw') }}">
                <span class="sidenav-mini-icon"><i class="material-icons">person</i> </span>
        ...
        <li class="nav-item">
            <a class="nav-link text-white " href="{{ route('admin.transferLog') }}">
                <span class="sidenav-mini-icon"><i class="material-icons">swap_horiz</i></span>
        ...
        <li class="nav-item ">
            <a class="nav-link text-white " href="{{ route('admin.banks.index') }}">
                <span class="sidenav-mini-icon"><i class="material-icons">account_balance</i>
                </span>
        ...
        <li class="nav-item ">
            <a class="nav-link text-white " href="{{ route('admin.contact.index') }}">
                <span class="sidenav-mini-icon"> <i class="material-icons">contacts</i> </span>
        ...
        <li class="nav-item ">
            <a class="nav-link text-white " href="{{ route('admin.bonus.index') }}">
                <span class="sidenav-mini-icon"> <i class="material-icons">card_giftcard</i> </span>
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link text-white " href="{{ route('admin.banners.index') }}">
                            <span class="sidenav-mini-icon"> <i class="material-icons">panorama</i>
                            </span>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link text-white " href="{{ route('admin.promotions.index') }}">
                            <span class="sidenav-mini-icon"><i class="material-icons">card_giftcard</i>
                            </span>
